...
const Web3 = require('web3').enable()   ;

const web3 = new Web3(ganache.provider()); // provider  helps to connect to any given network
...
describe('Lottery Contract', function(){
    ...
    it('only manager can call this function', async function(){
        try{
    ...
    it('sends money to the winner and resets the players array', async function(){
        ...
        const initialBalance = web3.utils.getBalance(accounts[0]);
